...
public class UI_Frame extends JFrame implements Runnable{
    ...
    UI_Frame() {
        ...
        creditLabel.setLocation(10, 333);
        creditLabel.setSize(380, 30);
        creditLabel.setFont(new Font(Font.MONOSPACED, Font.BOLD, 14));
    ...
    public void loadDetails() {
        ...
        startAgain.setForeground(new Color(3, 78, 116));
        ...
        endGame.setForeground(new Color(3, 50, 88));
    ...
    public void launch() {
        ...
        question.setForeground(new Color(3, 78, 116));
        ...
        for (int i = 0; i < 4; i++) {
            ...
            options[i].setForeground(new Color(3, 78, 116));
